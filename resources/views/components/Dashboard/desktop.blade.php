  ...
  <div class="text-serv-bg">
    ...
    <div class="flex items-center pt-8 pl-5 space-x-2 border-t border-gray-100">
      ...
      <span class="inline-block w-16 h-16 overflow-hidden bg-gray-100 rounded-full">
        ...
        <img src="{{ asset('storage/'.Auth::user()->detail_user->photo) }}" alt="">
        @else
    ...
    <ul class="mt-6">
      <li class="relative px-6 py-3">
        ...
        <a class="inline-flex items-center w-full text-sm font-medium text-gray-800 transition-colors duration-150 hover:text-gray-800 "
          ...
          @else
          <a class="inline-flex items-center w-full text-sm font-light text-gray-800 transition-colors duration-150 hover:text-gray-800 "
            href="{{ route('member.dashboard.index') }}">

            <svg width="20" height="20" viewBox="0 0 20 20" fill="white" stroke="black"
