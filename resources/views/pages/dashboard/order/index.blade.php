              ...
              <tr class="text-gray-700 border-b">
                ...
                <td class="px-1 py-5 text-sm w-2/8">
                  <div class="flex items-center text-sm">
                    ...
                    <div>
                      <p class="font-medium text-black">{{ $order->user_buyer->name }} lah</p>
                ...
                <td class="px-1 py-5 text-xs text-red-500">
                  @if ((strtotime($order->expired) - strtotime(date('Y-m-d'))) / 86400 >= 1 && $order->order_status_id
                  != 3)
                ...
                <td class="px-0 py-5 text-sm">
                  ...
                  <p class="px-4 py-2 mt-2 inline-block text-left text-green-500 "> Approved </p>
                  ...
                  <p class="px-4 py-2 mt-2 text-center text-red-600 rounded-xl bg-serv-email inline-block"> Rejected
                  </p>
...
<div class="flex h-screen">
  <div class="m-auto text-center">
    ...
    <p class="text-sm text-gray-400">
      It seems that you haven’t provided any Order. <br>
    </p>
