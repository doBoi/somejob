        ...
        <div class="px-6 py-2 mt-2 bg-white rounded-xl">
            ...
            <tbody class="bg-white">
              <tr class="mb-10 text-gray-700">
                  ...
                  <div class="flex items-center text-sm">
                    <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                      ...
                      <img class="object-cover w-full h-full rounded-full"
                        src="{{ asset('storage/'.$order->user_freelancer->detail_user->photo) }}" alt=""
                        loading="lazy" />
                    ...
                    <div>
                      ...
                      <p class="text-sm text-gray-400">{{ $order->user_freelancer->detail_user->contact_number ??'' }}
                      </p>
                ...
                <td class="px-1 py-5 text-xs text-red-500">
                  ...
                  <p class="text-green-500 inline-block"> DONE </p>
                  @elseif ((strtotime($order->expired) - strtotime(date('Y-m-d'))) / 86400 >= 1 &&
          ...
          <div class="flex p-8 border border-gray-200 rounded-lg bg-serv-upload-bg h-128">
            ...
            <div class="m-auto text-center">
              ...
              <h2 class="mt-8 mb-1 text-2xl font-semibold text-gray-700">
                {{ $order->file ? Str::substr($order->file,-10).'.zip':'File Not Available ' }}
              </h2>
              <p class="text-sm text-gray-400">
